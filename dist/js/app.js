...
form.forEach((element) => {
    element.addEventListener('submit', (event) => {
        ...
        const precoCookie = Number(quantidadeCookie) * Number(item === null || item === void 0 ? void 0 : item.preco);
        if (precoCookie === NaN) {
            console.log('quantidade de cookies inválida');
        }
        else {
            console.log(`O preço dos cookies ${item === null || item === void 0 ? void 0 : item.nome} é ${precoCookie}`);
        }
    });
});
